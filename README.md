...
If you don't have Matlab, you can start the GUIs directly with the Matlab compiled versions: 'LaserCAMkartesich.exe',  'LaserCAMzylindrisch.exe' or 'LaserCAMtangential.exe'. This only works if you have Matlab Compiler Runtime (MCR) installed.
