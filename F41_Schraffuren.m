...
WinkelUbergabe=0; %letzter Winkel der zwischen den Schraffurberechnungen übergeben wird
...
counter=1; %Index, der hilft die berechneten SectPts ins Array SectPts einzufüllen
    ...
    % Schritt 7: Skywritelinien berechnen
        ...
        %disp('Schritt 10');
        WinkelUbergabe=WinkelUbergabe+Drehoffsetlength*360/Umfang(k); 
        ...
        WinkelUbergabe=Schraffuren{k,1}(end,2); %Winkel für nächste Schraffurebenen berechnung speichern
