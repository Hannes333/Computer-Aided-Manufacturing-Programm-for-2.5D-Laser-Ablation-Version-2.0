...
%Header fuer Scangeschwindigkeit wird erstellt
Var.NCText.Header11=['F',int2str(Var.Scangeschw)];
...
set(handles.edit41,'String',Var.NCText.Header11);
...
set(handles.edit42,'String',Var.NCText.EbeneSta1);
set(handles.edit43,'String',Var.NCText.EbeneSta2);
set(handles.edit44,'String',Var.NCText.EbeneEnd1);
set(handles.edit45,'String',Var.NCText.EbeneEnd2);
...
Var.NCText.Header11=get(handles.edit41,'String');
...
Var.NCText.EbeneSta1=get(handles.edit42,'String');
Var.NCText.EbeneSta2=get(handles.edit43,'String');
Var.NCText.EbeneEnd1=get(handles.edit44,'String');
Var.NCText.EbeneEnd2=get(handles.edit45,'String');
Titelpfad=[Var.FolderName,'\',Var.Titel,'.txt'];

%Funktion, die den NC-Code erstellt
F50_NCCode(Var.Schraffuren,Titelpfad,Var.UmrandungKonturen,Var.NCText );
