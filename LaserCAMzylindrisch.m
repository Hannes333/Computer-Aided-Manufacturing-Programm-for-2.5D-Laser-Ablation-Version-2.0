...
set(handles.edit35,'String',num2str(DrehoffsetStart));
set(handles.edit25,'String',num2str(Drehoffset));
...
Var.DrehoffsetStart=DrehoffsetStart;
Var.Drehoffset=Drehoffset;
...
if ischar(FileName) && ischar(PathName)
    ...
    Drehoffset=str2double(text{2}(strncmpi('Drehoffset',text{1},16)));
    DrehoffsetStart=str2double(text{2}(strncmpi('DrehoffsetStart',text{1},21)));
...
if ischar(FileName) && ischar(PathName)
    ...
    fprintf(fid,['DrehoffsetStart:',get(handles.edit35,'String'),'\r\n']);
    fprintf(fid,['Drehoffset:',get(handles.edit25,'String'),'\r\n']);
...
elseif DrehoffsetStart<0
    ...
    Var.DrehoffsetStart=abs(DrehoffsetStart);
else
    Var.DrehoffsetStart=DrehoffsetStart;
end
